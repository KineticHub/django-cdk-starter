...
class DatabaseStack(Stack):
    ...
    def __init__(
        ...
        self.create_aurora_cluster(scope)
        # self.create_postgres_instance(scope)

    def create_aurora_cluster(self, scope):
    ...
    # def create_postgres_instance(self, scope):
    ...
    #         backup_retention_period=Duration.days(self.backup_retention_days),  # 1 day retention is free
    #         deletion_protection=True,
    #     )
    #     # Allow ingress traffic from ECS tasks
    #     self.postgres_db.connections.allow_default_port_from_any_ipv4(
    #         description="Services in private subnets can access the DB"
    #     )
    #     # Save the name of the autogenerated secrets manager secret holding database credentials
    #     self.ssm_db_secret_name_param = ssm.StringParameter(
    ...
    #         "DatabaseSecretNameParam",
    #         parameter_name=f"/{scope.stage_name}/DatabaseSecretNameParam",
    #         string_value=self.postgres_db.secret.secret_name
    #     )